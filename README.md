...
- Spring MVC와 3-Tier 아키텍처 기반의 대학생 중심 통합 커뮤니티 및 학사 지원 플랫폼<br>

<br>

### 1-2. 서비스설명
- Spring MVC와 3-Tier Architecture를 채택하여 계층 간 독립성을 보장하고 유지보수가 용이한 구조를 설계했습니다 <br>
- WebSocket 및 STOMP 프로토콜을 활용한 그룹 채팅과 AJAX 비동기 통신을 통해 사용자 경험을 극대화한 실시간 인터랙션을 구현했습니다 <br>
- 게시판(CRUD), 메일, 실시간 채팅 등 커뮤니케이션 도구와 더불어 열람실 발권, 도서 검색 등의 학사 행정 지원 기능을 결합한 통합 플랫폼입니다 <br>
- Bootstrap을 활용한 직관적인 UI 설계로 사용자의 접근성을 높였으며, 페이징 및 통합 검색 기능을 통해 데이터 접근 효율을 최적화했습니다 <br>
<br>

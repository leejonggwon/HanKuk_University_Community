...
### 1-4. 시연영상
[https://www.youtube.com/watch?v=HDL472NQWXA](https://youtu.be/UqHG0QnJ2_I)
...
### 7-3. 데이터 무결성을 위한 논리적 삭제(Soft Delete)
...
## 10. 실시간 그룹 오픈채팅 시스템 (WebSocket) <br>
### 10-1. 주요 특징 (Key Features) <br>
...
### 10-2. [Server] 세션 핸들링 및 메시지 브로드캐스팅 <br>
...
### 10-3. [Client] 동적 UI 및 웹소켓 이벤트 처리 <br>
